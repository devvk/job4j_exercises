...
public class Task148Test {
    ...
    public void when10And10And5214And5532Then2And10And7And0And3() {
        ...
        String expected = "Группы: 2, Взрослых: 10, детей: 7, осталось билетов взр: 0, осталось "
                + "билетов дет: 3" + ln;
    ...
    public void when10And10And22142And22212Then4And7And9And3And1() {
        ...
        int[] aNum = {2, 2, 2, 1, 2};
        Task148.loop(10, 10, cNum, aNum);
        String expected = "Группы: 4, Взрослых: 7, детей: 9, осталось билетов взр: 3, осталось "
                + "билетов дет: 1" + ln;
        assertThat(out.toString()).isEqualTo(expected);
    }
    ...
    public void when10And10And10And2And10And3Then1And10And10And0And0() {
        ...
        int[] aNum = {10, 3};
        Task148.loop(10, 10, cNum, aNum);
        String expected = "Группы: 1, Взрослых: 10, детей: 10, осталось билетов взр: 0, осталось "
                + "билетов дет: 0" + ln;
        assertThat(out.toString()).isEqualTo(expected);
    }
}
