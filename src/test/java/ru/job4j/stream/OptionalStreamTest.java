...
import static ru.job4j.stream.OptionalStream.PhoneNumber;
...
public class OptionalStreamTest {
    ...
    public void test() {
        ...
        assertEquals(
                "+7 123 345 61 93",
                OptionalStream.collectNumber(List.of(u1, u2, u3, u4), 3, "+7").getFirst().phone()
        );
    }
